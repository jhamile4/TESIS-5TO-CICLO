...
export default function Sidebar({ business }) {
  ...
  const handleLogout = async () => {
    await logout()
    window.location.assign(`${PUBLIC_URL}/tiendas`)
  }
