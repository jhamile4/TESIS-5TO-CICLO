// Modal de vista rápida de un negocio desde el Directorio
// Muestra info del negocio, tabs de productos y reseñas, y botones de acción
      ...
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div className="modal-actions">
            <button className="modal-btn-primary" onClick={() => navigate('/tienda/' + negocio.slug)}>
